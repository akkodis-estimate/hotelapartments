...
import { BsCalendar, BsCalendar2Date, BsCalendar3 } from "react-icons/bs";
  ...
  return (
    <>
      <div className="modal-header border-0 p-0">
        <h2>{t("pages.AccountSettings.booking.extension.title")}</h2>
        <button
          type="button"
          className="btn-close"
          onClick={() => {
          ...
          <div className="ha--Samerow">
            ...
            <div className="ha-sameRowCol">
              ...
              {/* <input
                  ...
                  name="end_date"
                  className="form-control"
                  min={moment(props?.data?.check_out).format("YYYY-MM-DD")}
              ...
              <DatePickerInput
                ...
                minDate={moment(props?.data?.check_out).toDate()}
              />
