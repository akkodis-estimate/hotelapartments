...
const PersonalPageOtp = (props) => {
    ...
    authenticationService
      ...
      .then((res) => {
        if (res.data.statusCode !== 400) {
          navigate(RoutePaths.ACCOUNT.ACCOUNT_SETTINGS, {
            state: { isUpdatedOtp: true },
          });
  ...
  return (
    <>
        ...
        <div className="col-lg-6">
          <div className="otpDesign d-flex flex-column align-items-center justify-content-center">
            ...
            <span className="counterSec">
              {" "}
              {props.countdownSeconds ? props.countdownSeconds: 0} sec.
            </span>
      ...
      <ModalPopup show={errorForOtp} dialogClassName="applicationModal">
        <SuccessModalPopup
          setSuccessModal={setErrorForOtp}
          Title={"Error"}
          Message={"Something Went Wrong With OTP, Please Check Again."}
          ShowButton={false}
        />
      </ModalPopup>
    </>
...
export default PersonalPageOtp;
