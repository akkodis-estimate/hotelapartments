...
const RePayments = () => {
  ...
  }, [language, currency_code, countryDropdown]);
  ...
  const redirectPayment = async (e) => {
    ...
    if (isRequiredFieldsAreValid) {
      ...
      try {
        const res = await bookingService.RE_PAYMENT_UPDATE(
          booking_sid,
          req_body
        );
...
if (countryDropdown.length > 0) {
  ...
  return (
    <div className="ha--BookingContaier ha--RepyamentDes">
                              ...
                              <div class="form-check d-flex align-items-start gap-2 moreFilterLayout">
                                ...
                                <div className="d-flex flex-column">
                                  ...
                                  <span className="payNote">
                                    {t(
                                      "pages.booking.remaining_loyalty_points"
                                    )}
...
<hr className="ha--payOptionHr" />
                  ...
                  <>
                    ...
                    <div className="ha--payOptionColumnRadio">
                        <div
                          ...
                          style={{
                            opacity:
                              Number(bookingData?.credit_limit) &&
                              Number(bookingData?.credit_limit) > 0
                                ? 1
                                : 0.5,
                            cursor:
                              Number(bookingData?.credit_limit) &&
                    ...
                    {isCreditChecked &&
                    finalPrice <= Number(bookingData?.credit_limit) ? (
                      <></>
                    ) : (
                      <>
                       <hr className="ha--payOptionHr" />
                ...
                <div className="ha--CheckOutFormBooking">
                <div className="checkoutTitleDetail ha--billingTitleCust">
                        <h5>
                          {t(
                  ...
                  <div className="ha--CheckOutFormBookingRow">
                    ...
                    <div className="ha--bookingFormColumn">
                      <label className="form-label">
                        {t("pages.booking.multibooking_payment.street_address")}
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="cancelaationPolicy">
                        ...
                        <div className="actionBtn ha--PaymentBtmBtn">
                          ...
                          >
                            {t(
                              "pages.booking.multibooking_payment.request_book"
                            )}
                          </button>
                        </div>
