...
import "Pages/Properties/FeaturedProperties/Components/ApartmentList/ApartmentList.css";
...
import { Rating, Accordion } from "@mantine/core";
...
const ApartmentList = () => {
  ...
  useEffect(() => {
    ...
    //         customerSID +
    //         "&checkIn=" +
    //         startDateFromQuoteParam +
    //         "&checkOut=" +
    //         endDateFromQuoteParam
    //       )}`,
    //     },
    //   });
    // }
    ...
    const apartment_list = setTimeout(() => {
      ...
      if (!firstLoad && filtersInURL) {
        ...
        for (const item of keyValuePair) {
          ...
          //   setFilteredBedroomsString(keyValue[1]?.length > 0 ? keyValue[1].join(";") + " beds" : "")
          // }
          ...
          //   setFilteredBedroomsString(...filteredBedroomsString, keyValue[1]?.length > 0 ? keyValue[1].join(";") + " baths" : "")
          //   setIsStudio(false);
          // }
          ...
          if (kvpObj.urlKey == "bedrooms") {
            ...
            //   (prevString) =>
            //     nameValues
            //       ? `${nameValues.join("; ")} ${t("common_lables.beds")}`
            //       : prevString
            // );

            setFilteredBedroomsString((prevString) => {
              if (nameValues) {
                const studioIndex = nameValues.indexOf("studio");
                if (studioIndex !== -1) {
                  const studioLabel =
                    selectedLang === "ru" ? "Студия" : "Studio";
                  const valuesWithoutStudio = [
                    ...nameValues?.slice(0, studioIndex),
                    ...nameValues?.slice(studioIndex + 1),
                  ];

                  return `${studioLabel}; ${valuesWithoutStudio.join("; ")} ${t(
                    "common_lables.beds"
                  )}`;
                } else {
                  return `${nameValues.join("; ")} ${t("common_lables.beds")}`;
                }
              } else {
                return prevString;
              }
  ...
  const bedbathFilterApply = () => {
    ...
    // setFilteredBedroomsString(
    //   (bedroomsSelected?.length > 0 ? bedroomsSelected.join(", ") + " " + t('common_lables.beds') : "") +
    //   (bathroomsSelected?.length > 0 ? (bedroomsSelected?.length > 0 ? ", " : "") + bathroomsSelected.join("; ") + " " + t('common_lables.baths') : "")
    // );
  ...
  const loadListOnMap = (maximumMapValue) => {
    //debugger
    dispatch(maskingActions.showMasking());
    if (maximumMapValue) {
      setlistParams((previousState) => {
    ...
    <div className="FeaturedPropertiesContainer">
      <div className="filter_main">
              ...
              <div className="advanceFilter">
                <div className="col">
                  <div className="filterDD autoCompleteSearch h-100">
                    {/* <Select
                      ...
                      // value={cityCountryDropdown?.find(
                      //   (f) =>
                      //     f.city_id ===
                      //     filterData?.find((x) => x.key === "city_id")
                      // )}
                      value={locationValue}
                    ...
                    <Select
                      // placeholder={t(
                      //   "pages.properties.feature_properties.location"
                      // )}
                      placeholder={t(
                        "pages.properties.feature_properties.city"
                      )}
                      itemComponent={SelectItem}
                      ...
                      onChange={(e) => {
                        ...
                        // if (e === null) {
                        //   handleDropdownFilter("area_sid", "");
                        //   setAreaValues([]);
                        //   setAreaSID(null);
                        //   handleDropdownFilter("location_sid", "");
                        //   setPropAptValues([]);
                        //   setPropAptSID(null);
                        // }
                      }}
                      ...
                      renderOption={(option) => (
                        <div key={option.primary_sid}>
                          {" "}
                          {/*style={{ flexBasis: '50%', padding: '0.5rem' }} */}
                          <p>{option.label}</p>
                        </div>
                      )}
                      value={locationValue}
                ...
                <div className="col">
                  <div className="filterDD autoCompleteSearch h-100">
                    <Select
                      placeholder={t(
                        "pages.properties.feature_properties.area"
                      )}
                      itemComponent={AreaSelectItem}
                      data={areaValues ? areaValues : []}
                      ...
                      clearable={true}
                      onChange={(e) => {
                        handleDropdownFilter("area_sid", e === null ? "" : e);
                        setAreaSID(e);
                ...
                <div className="col ">
                  <div className="filterDD autoCompleteSearch h-100">
                    <Select
                      ...
                      data={propAptValues ? propAptValues : []}
                      ...
                      value={propAptSID ? propAptSID : ""}
                      icon={<PropertiesIcon className="propertyIconColor" />}
                    />
                  </div>
                </div>

                <div className="col apartmentListCalCust">
                  <DatePickerInput
                        ...
                        <div className="card-body">
                          ...
                          <div className="row mb-3 mt-5">
                            <div className="col-lg-12">
                              <label className="moreFltrLbl">
                                {t(
                                  "pages.properties.feature_properties.bathrooms"
                                )}
                              </label>
                            </div>
                          </div>
                    ...
                    >
                      <div className="d-flex align-items-center">
                        ...
                        <div className="d-flex flex-column align-items-start">
                          <span>
                            {t(
                              "pages.properties.feature_properties.price_range"
                            )}
                          </span>
                    ...
                    >
                      <div className="card bg-transparent border-0 p-0">
                          ...
                          >
                            ...
                            <div className="row mb-3">
                                <div className="col-lg-12 ">
                                  <label className="moreFltrLbl">
                                    {t(
                                      "pages.properties.feature_properties.rating"
                                    )}
                                  </label>

                                  {/* <Rating size="xl" value={ratingValue} onChange={}/> */}
                                  <div>
                                    {[1, 2, 3, 4, 5].map((index) => (
                                      <span
                                        key={index}
                              ...
                              {/* <div className="row mb-3 mt-5">
                              <div className="col-lg-12 ">
                                <label className="moreFltrLbl mb-3">
                                  {t(
                                    "pages.properties.feature_properties.price_range"
                                  )}
                                </label> */}
                              ...
                              {/* <RangeSlider
                                  ...
                                  onChange={(e) => {
                                    setPriceFilter(e);
                                    //handleRangeFilter('price', '', e[0], e[1])
                                  }}
                                /> */}

                              {/* <div className="priceFlterChange d-flex flex-column gap-1 flex-start">
                                  {PriceFilter?.map((item, index) => (
                                    <p className="cursor-pointer filtrChangeHover" onClick={() => { setPriceRange(item) }}>
                                      {item.value}
                                    </p>
                                  ))}
                                </div>
                        ...
                        <div className="filterFtrBtn pt-3 pb-3 card-footer d-flex bg-transparent justify-content-between align-items-center">
                          ...
                          <button
                            //disabled={isMoreFilterApplied}
                            type="button"
                            //className={`bg-transparent border-0 p-0 ${isMoreFilterApplied ? 'disabledApplyButtonForMore' : ''}`}
                            className="bg-transparent border-0 p-0"
                            onClick={() => {
                              moreFiltersApply();
                            }}
                ...
                <div className="col d-flex justify-content-end shareDDApartmentsm">
              ...
              <div className="filter_content">
                <div className="featuredPropertyTitle">
                  <h2>
              ...
              <div className="appartmentListParaSm">
                {meta?.description_string &&
                  meta?.description_string !== "NULL" && (
                    <div className="appartmentListPara">
                      {/* <p>{meta?.description_string}</p> */}
                      <p>
                        {meta?.description_string &&
                          meta?.description_string
                            ?.split(/([.?])/)
                    ...
                    <div>
                      <div className="d-inline-flex align-items-center gap-3">
                        {specialOffer && (
                          <div className="spclOffer d-inline-flex align-items-center gap-3">
                            {t(
                              "pages.properties.feature_properties.special_offers"
                            )}
                            <span
                              className="closeOffer"
                              onClick={() => {
                ...
                {meta?.area_not_found_string &&
                  meta?.area_not_found_string !== "NULL" && (
                    <div className="d-inline-flex">
                      ...
                      >
                        {" "}
                        <BsExclamationCircle /> {meta?.area_not_found_string}
                      </p>
                    </div>
                  )}

                {meta?.greet_string && meta?.greet_string !== "NULL" && (
                  <div className="appartmentListPara mt-3 mb-3">
                    <p
            ...
            <div className="filter_right">
              <div className="breadCrumbProperties">
                <div className="appBreadCrumb mb-3">
                  <ul className="breadcrumbList d-flex align-items-start justify-content-end flex-unwrap">
                    <li
                    ...
                    <li className="breadcrumbItem">
                      ...
                      {/* {searchValues?.find((f) => f.primary_sid === filterData?.find((x) => x.key === "city_sid")?.value)?.name
                        ?

                        selectedLang === "ru" ?
                          searchValues?.find((f) => f.primary_sid === filterData?.find((x) => x.key === "city_sid")?.value)?.russian_name
                          : searchValues?.find((f) => f.primary_sid === filterData?.find((x) => x.key === "city_sid")?.value)?.name
              ...
              <div className="shareDD ">
                ...
                <div className="sortingFilterCustSm">
              <div className="mapActionSm">
                <div className="filterDD w-100 sortByDD">
                  <button
                    class="btn btn-secondary dropdown-toggle d-flex align-items-center justify-content-around bg-transparent gap-4"
                    type="button"
                    data-bs-toggle="dropdown"
                  ...
                  >
                    {t("pages.properties.feature_properties.sort")}
                    <BsChevronDown />
                  </button>
                  <ul
                  ...
                  >
                    ...
                    <li className="sortByItem">
                      <div class="form-check d-flex align-items-center gap-2">
                        ...
                        >
                          {t(
                            "pages.properties.feature_properties.featured_first"
                          )}
                        </label>
                      </div>
                    </li>
                ...
                <div className="mapOpenBtn">
                  <div className="animateBtn me-3">
                    <button
                      type="button"
                      className="appBtn bg-white"
                      onClick={() => setMaximumMap(true)}
                    >
                      {t("pages.properties.feature_properties.open_map")}
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="gridListView">
                <div
                  className={`gridListViewItem  ${displayTab ? "active" : ""}`}
                  onClick={onGridClick}
                >
                  <GridIcon />
                </div>
      ...
      {!isMasked && !isLoading && !loadingData ? (
        <>
          {" "}
          {/* <div
            className={`main_property ${!displayTab ? "listViewAppCard" : ""
              }`}
          > */}
          <div className={`main_property ${!displayTab ? "listViewAppCard" : ""} ${ !MaximumMap ? "" : "main_property_spacing"} `}>
            <div
              className={` ${apartmnetList?.length > 0 && MaximumMap ? "d-none" : "list_property"
                }  ${apartmnetList?.length > 0 && MapAside ? "list_propertyMaxiMize" : ""}`}
            >
              {apartmnetList && apartmnetList.length > 0 ? (
                <div className="propertiesLayout">
                  {apartmnetList.map((item, index) => (
                    <div
                      className={`${displayTab ? "view_grid" : "view_list"} ${displayTab && MapAside ? "mapDesCustSm" : ""
                        }`}
                    >
                      <PropertiesCard
                        key={index}
            ...
            <div
              className={` position-relative mapDesCustSm  ${MaximumMap ? "mapCustomization" : ""
                }  ${MapAside ? "mapAsideCustomization h-100" : ""}`}
            >
              {/* {mapDetails && mapDetails.length > 0 && <PropertiesMap propertyDetails={mapDetails} />} */}
              ...
              /> */}
                  ...
                  <FeaturedMap
                    ...
                    locationValue={
                      propAptSID
                        ...
                        : areaSID
                          ? {
                            name: areaValues?.find(
                              (x) => x.primary_sid === areaSID
                            )?.area_name,
                            entity_name: "area",
                          }
                          : locationValue
                  ...
                  <div className="mapActionBtn d-flex align-items-center gap-4">
                    <div className="maximiseMinize insideMapAction">
                      {!MaximumMap && (
                        <span
                          onClick={() => {
                            setMaximumMap(true);
                    ...
                    <div className="animateBtn appMainBtn me-3 insideMapAction">
                      {!MapAside ? (
                        <button
                          type="button"
                          className="appBtn bg-white"
                        ...
                        >
                          <span>
                            {t("pages.properties.feature_properties.close_map")}
                          </span>
                        </button>
                      ) : (
                        <button
                    ...
                    <div className="animateBtn me-3 minMapBtnClose">
                      <button
                        type="button"
                        className="appBtn bg-white"
                        onClick={() => {
          ...
          {!isMasked && !isLoading && !loadingData && apartmnetList == null && (<div className="noFind_data">
                    <div className="noFilterData warningBookingContent d-flex flex-column align-items-start justify-content-center mb-5">
          ...
          <div className={`property_bottom_content ${MapAside ? "ha--paginationFull" : ""}`}>
            {/* <div className="col-lg-8 d-flex justify-content-center pb-5"> */}
            <div
              className={`pagination_main  ${MapAside ? "paginationFull" : ""
                } ${MaximumMap ? "d-none" : ""}`}
            >
              {/* <div className="animateBtn me-3">
            {!MaximumMap && displayedData?.length < apartmnetList?.length && (
              ...
              {apartmnetList && apartmnetList?.length > 0 && (
                <div className="paginationAppartmentList">
                  <div
                  ...
                  >
                    ...
                    <span>{t("common_lables.previous")}</span>
                  </div>
                  <div className="totalPaginationCount">
                    <span>
                      {meta?.page} {t("common_lables.of")}{" "}
                      {meta?.total_page_num}
                    </span>
                  </div>
                  <div
                    ...
                    onClick={() => onNextPage()}
                  >
                    <span>{t("common_lables.next")}</span>
                    <div>
                      <BsChevronRight />
                    </div>
                  </div>
            ...
            <p>{t("pages.properties.feature_properties.about_us.info4")}</p> */}
                ...
                {/* <div className="moreExplore mt-5">
              <h5 className="mb-5">More to explore</h5>

              <div className="exploreBlurb mb-5">
              ...
              <div className="exploreBlurb">
                ...
                <div className="moreExplore">
                  <h5>{t("common_lables.more_to_explore")}</h5>

                  {/* Areas */}
                  {meta?.area_array && meta?.area_array?.length > 0 && (
                    <div className="exploreBlurb">
                      <div className="d-flex align-items-center">
                        <span>
                          <MapIcon />
                      ...
                      {/* <ul className="d-flex align-items-center exploreListItem">
                  {meta?.area_array?.filter(item => item.is_popular)?.slice(0, 3).map((area, index) => (
                    <li key={index}>{area.area_name}</li>
                  ))}
                  {meta?.area_array?.length > 3 && <li>+ {meta?.area_array?.length - 3} more</li>}
                </ul> */}

                      <ul className="d-flex align-items-center flex-wrap exploreListItem">
                        {meta?.area_array
                          .filter((item) => item.is_popular)
                          .slice(0, 3)
                          .map((area, index) => (
                            <li className="cursor-pointer" 
                            // onClick={() => { seoInfoClick(area.link) }}
                             key={index}>
                              {/* {area.area_name} */}
                              <a href={seoInfoClick(area.link)} target="_blank" >
                                {area.area_name}
                              </a>
                              </li>
                          ))}
                  ...
                  <ModalPopup show={showAllAreas} dialogClassName="AreasModal">
                    <AreasListModal
                  ...
                  {meta?.property_array && meta?.property_array?.length > 0 && (
                    <div className="exploreBlurb">
                      ...
                      {/* <ul className="d-flex align-items-center exploreListItem">
                  {meta?.property_array?.filter(item => item.is_popular)?.slice(0, 3).map((hotel, index) => (
                    <li key={index}>{hotel.name}</li>
                  ))}
                  {meta?.property_array?.length > 3 && <li>+ {meta?.property_array?.length - 3} more</li>}
                </ul> */}
                      ...
                      <ul className="d-flex align-items-center flex-wrap exploreListItem">
                        {meta?.property_array
                          ...
                          .map((hotel, index) => (
                            <li className="cursor-pointer"
                            //  onClick={() => { seoInfoClick(hotel.link) }} 
                             key={index}>
                              {/* {hotel.name} */}
                              <a href={seoInfoClick(hotel.link)} target="_blank">
                                {hotel.name}
                              </a>
                              </li>
                          ))}
        ...
        <>
          {!MaximumMap && (
            <div className="blank_file">
              ...
              <div className=" position-relative mapDesCustSm">
                <div className="mapSkeleton">
                  <Skeleton height={675} mb="xl"></Skeleton>
                </div>
              </div>
              </div>
            </div>
          ...
          {MaximumMap && (
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="mapSkeleton">
                  <Skeleton height={775} mb="xl"></Skeleton>
                </div>
              </div>
            </div>
          )}
